	...
	<div>
		<div style="margin-bottom: 20px;">
			...
			>
				<template #prepend>
					<el-icon>
						<Search style="cursor: pointer;" @click="getTableList" />
					</el-icon>
				</template>
			</el-input>
			...
			<div style="float: right;">
				...
				<el-button v-if="auth.add" type="primary" @click="addData">
		...
		<el-table
			...
			stripe
			style="width: 100%"
			@selection-change="chosedData"
		>
			<el-table-column type="selection" width="46" />
			<el-table-column label="名称" prop="name">
				<template #default="scope">
					<div v-if="scope.row.avatar" class="user_avatar">
			...
			<el-table-column label="操作" align="right" width="150px">
				<template #default="scope">
					<el-button
						v-if="auth.delete && user.user?.id !== scope.row._id"
						size="small"
						type="danger"
						@click="deleteTableData(scope.row._id)"
					>
						删除
					</el-button>
					<el-button
		...
		<el-pagination
			v-model:page-size="searchOption.limit"
