<template>
    <el-dialog v-model="props.show" draggable show-close @close="() => emit('cancel')"
        :title="!!props.editId ? '修改用户' : '新建用户'" width="600px">
        <el-form :model="userForm" size="default" label-width="140px" style="width: 600px;padding: 38px 0;"
            :rules="formRules" ref="formRef" status-icon>
            ...
            <el-form-item label="密码" prop="password1">
                <el-input v-model="userForm.password1" show-password type="password" placeholder="请输入密码"
                    style="width: 200px;" />
            </el-form-item>
            <el-form-item label="再次输入" prop="password2">
                <el-input v-model="userForm.password2" show-password type="password" placeholder="请再次输入密码"
                    style="width: 200px;" />
            </el-form-item>
        </el-form>
...
const props = defineProps(['editId', 'show']);
