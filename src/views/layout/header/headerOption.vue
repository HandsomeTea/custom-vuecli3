<template>
	<ul>
		...
		<li class="option">
			<el-dropdown trigger="click" class="user_option" @command="userOperation">
				...
				<template #dropdown>
					<el-dropdown-menu>
						<el-dropdown-item :icon="Setting" command="/index">
							设置
						</el-dropdown-item>
						<el-dropdown-item :icon="SwitchButton" command="logout" class="logout">
							退出登录
						</el-dropdown-item>
					</el-dropdown-menu>
				</template>
